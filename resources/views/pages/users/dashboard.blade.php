...
@section('container')
{{-- style="background-image: linear-gradient(180deg, #65b1d4, #ffffff, #39464d);" --}}
<header class="page-header" style="background-image: linear-gradient(0deg, #376479, #26414e, #1a2024);">
    <h2>{{ $title }}</h2>
                        ...
                        <div class="widget-summary">
                            ...
                            <div class="widget-summary-col">
                                ...
                                <div class="summary-footer">
                                    <a class="btn btn-danger" href="/viewProducts">(Lihat Produk)</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="widget-summary">
                            ...
                            <div class="widget-summary-col">
                                ...
                                <div class="summary-footer">
                                    <a class="btn btn-danger" href="/myOrders">Lihat Daftar Pesanan Produk Saya</a>
                                </div>
                            </div>
                        </div>
                    </div>
