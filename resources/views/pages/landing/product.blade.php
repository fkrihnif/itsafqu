                ...
                <div class="portfolio-item">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mt-2 mx-4">
                        <a href=""><button type="button"
                                class="btn btn-outline btn-success btn-sm mb-2">Pesan</button></a>
                        <a href=""><button type="button"
                                class="btn btn-outline btn-info btn-sm mb-2">Preview</button></a>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 col-lg-3 isotope-item websites">
            ...
            <div class="col-sm-4 col-lg-3 isotope-item websites">
                <div class="portfolio-item">
                    <a href="portfolio-single-wide-slider.html">
                        <span class="thumb-info thumb-info-lighten border-radius-0">
                            <span class="thumb-info-wrapper gambar border-radius-0">
                                <img src="frontend/img/web/Asset 2.png"
                                    class="img-fluid border-radius-0 plugin-random-images"
                                    data-plugin-random-images
                                    data-plugin-options="{'imagesListURL': ['frontend/img/web/Asset 2.png', 'frontend/img/web/Asset 2.png'], 'delay': 2800, 'animateIn': 'blurIn', 'animateOut': 'fadeOut'}"
                                    alt="" style="height: 350px!important">

                                <span class="thumb-info-title">
                                    <span class="thumb-info-inner">Template W3</span>
                                    <span class="thumb-info-type">Website</span>
                                </span>
                            </span>
                        </span>
            ...
            <div class="col-sm-4 col-lg-3 isotope-item brands">
                <div class="portfolio-item">
                    <a href="portfolio-single-wide-slider.html">
                        <span class="thumb-info thumb-info-lighten border-radius-0">
                            <span class="thumb-info-wrapper gambar border-radius-0">
                                <img src="frontend/img/gambar/2a.jpg"
                                    class="img-fluid border-radius-0 plugin-random-images"
                                    data-plugin-random-images
                                    data-plugin-options="{'imagesListURL': ['frontend/img/gambar/2b.jpg'], 'delay': 3000, 'animateIn': 'blurIn', 'animateOut': 'fadeOut'}"
                                    alt="" style="height: 350px!important">

                                <span class="thumb-info-title">
                                    <span class="thumb-info-inner">Template G2</span>
                                    <span class="thumb-info-type">Gambar</span>
                                </span>
                            </span>
                        </span>
                    ...
                    <a href="portfolio-single-wide-slider.html">
                        <span class="thumb-info thumb-info-lighten border-radius-0">
                            <span class="thumb-info-wrapper gambar border-radius-0">
                                ...
                                <span class="thumb-info-title">
                                    <span class="thumb-info-inner">Template G3</span>
                                    <span class="thumb-info-type">Gambar</span>
                                </span>
                            </span>
                        </span>
