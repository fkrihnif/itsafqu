                ...
                <table class="table table-bordered table-striped mb-0" id="datatable-default">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            @if ($video->is_recommended == 'NO')
                                <a href="actioneditvideo/{{ $video->id }}" type="submit" onclick="return confirm('Yakin ingin mengubah menjadi Recommended?');" class="btn btn-warning btn-sm">NO</a>
                            @else
                            <a href="actionedittvideo/{{ $video->id }}" type="submit" onclick="return confirm('Yakin ingin mengubah menjadi tidak Recommended?');" class="btn btn-success btn-sm">YES</a>
                            @endif
                            </td>
                            <td>
