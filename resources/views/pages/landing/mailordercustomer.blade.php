...
<head>
  ...
  <meta name="Simdalida - Sanggau" content="width=device-width" />
  <title>Order Undangan</title>
  <style type="text/css">
                        ...
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                             Hai kak, silahkan lanjutkan pembayaran kakak sebelum {{ $deadline }}, dengan total pembayaran @currency($price). <br>
                             <p class="mb-0">Silahkan Transfer ke :</p>
                             <h4 class="mb-0"> BNI Syariah : 8880806213</h4>
                             <p><b>A.N ITSAFQU</b></p>
                             <br>
                             Jika sudah melakukan pembayaran, Silahkan Hubungi WhatsApp 081345025914 atau melalui <a href="https://api.whatsapp.com/send?phone=62895380000239&text=Bismillah, Saya mau konfirmasi pembayaran dengan kode pemesanan{{ $kode_pesanan }}"
                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>TerimaKasih</p>
                              <p>Email ini dikirimkan secara otomatis oleh sistem, kami tidak melakukan pengecakan email yang dikirimkan ke email ini. Jika ada pertanyaan, silahkan Hubungi <a href="https://api.whatsapp.com/send?phone=62895380000239&text=Bismillah, Saya mau bertanya.."
